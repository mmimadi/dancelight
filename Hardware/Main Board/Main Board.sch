...
F 1 "NPN" H 3071 4615 50  0000 L CNN
F 2 "" H 3080 4760 50  0001 C CNN
...
U 1 1 5EB245CF
P 1060 5070
F 0 "MK1" H 1190 5116 50  0000 L CNN
F 1 "MIC" H 1190 5025 50  0000 L CNN
F 2 "" V 1060 5170 50  0001 C CNN
F 3 "~" V 1060 5170 50  0001 C CNN
	1    1060 5070
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5EB3EDFD
P 1060 4620
F 0 "R1" H 870 4585 50  0000 L CNN
F 1 "6.8k" H 870 4495 50  0000 L CNN
F 2 "" H 1060 4620 50  0001 C CNN
...
U 1 1 5EC19F82
P 4365 2680
F 0 "U2" H 4245 2985 50  0000 C CNN
F 1 "NCP718A" H 4360 2910 50  0000 C CNN
F 2 "Footprints:SON65P200X200X80-7N" H 4365 3005 50  0001 C CNN
F 3 "https://www.onsemi.com/pub/Collateral/NCP718-D.PDF" H 4365 2780 50  0001 C CNN
	1    4365 2680
	1    0    0    -1  
$EndComp
Text Notes 655  1860 0    50   ~ 0
...
U 1 1 5EC728F7
P 5675 2365
F 0 "#PWR016" H 5675 2215 50  0001 C CNN
F 1 "+5V" H 5690 2538 50  0000 C CNN
F 2 "" H 5675 2365 50  0001 C CNN
F 3 "" H 5675 2365 50  0001 C CNN
	1    5675 2365
	1    0    0    -1  
$EndComp
...
F 1 "NPN" H 2301 4815 50  0000 L CNN
F 2 "" H 2310 4960 50  0001 C CNN
...
U 1 1 5EDC1E29
P 890 2475
F 0 "#PWR030" H 890 2325 50  0001 C CNN
F 1 "+BATT" H 890 2645 50  0000 C CNN
F 2 "" H 890 2475 50  0001 C CNN
F 3 "" H 890 2475 50  0001 C CNN
	1    890  2475
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5EF7B517
P 2975 2380
F 0 "#PWR010" H 2975 2230 50  0001 C CNN
F 1 "+10V" H 2990 2553 50  0000 C CNN
F 2 "" H 2975 2380 50  0001 C CNN
F 3 "" H 2975 2380 50  0001 C CNN
	1    2975 2380
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5F201A91
P 4365 3295
F 0 "#PWR015" H 4365 3045 50  0001 C CNN
F 1 "GNDA" H 4370 3122 50  0000 C CNN
F 2 "" H 4365 3295 50  0001 C CNN
F 3 "" H 4365 3295 50  0001 C CNN
	1    4365 3295
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 1 "?" V 2989 3205 50  0000 C CNN
F 2 "" V 3065 3205 50  0001 C CNN
...
U 1 1 5F336FEA
P 3870 2095
F 0 "D1" H 3910 1900 50  0000 R CNN
F 1 "1N5819" H 3995 2000 50  0000 R CNN
F 2 "" H 3870 2095 50  0001 C CNN
F 3 "~" H 3870 2095 50  0001 C CNN
	1    3870 2095
	-1   0    0    1   
$EndComp
Wire Wire Line
...
Wire Wire Line
	4065 2680 4065 3145
Text Label 4065 3145 1    50   ~ 0
MAIN_POWER
Connection ~ 6305 3585
Wire Wire Line
	6305 3580 6305 3585
Wire Wire Line
	6155 3580 6305 3580
...
Wire Wire Line
	6615 3585 7835 3585
Connection ~ 6615 3585
$Comp
L Device:C_Small C10
U 1 1 5EC62A87
P 6305 3685
F 0 "C10" H 6235 3905 50  0000 L CNN
F 1 "10uf" H 6225 3835 50  0000 L CNN
F 2 "" H 6305 3685 50  0001 C CNN
F 3 "~" H 6305 3685 50  0001 C CNN
	1    6305 3685
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5EC989DA
P 6615 3685
F 0 "C11" H 6555 3905 50  0000 L CNN
F 1 ".1uf" H 6555 3835 50  0000 L CNN
F 2 "" H 6615 3685 50  0001 C CNN
F 3 "~" H 6615 3685 50  0001 C CNN
	1    6615 3685
	1    0    0    -1  
$EndComp
Text Label 6770 4300 0    50   ~ 0
LED
Text Label 6770 4000 0    50   ~ 0
MIC_IN
Text Label 6770 4100 0    50   ~ 0
TEMP_SENSE
Wire Wire Line
	6770 4100 7235 4100
Wire Wire Line
...
Wire Wire Line
	7235 4200 6770 4200
Text Label 6770 4200 0    50   ~ 0
MODE
Wire Wire Line
	8435 4100 8900 4100
Text Label 8900 4100 2    50   ~ 0
PACK_SENSE
Text Label 8905 4200 2    50   ~ 0
MAIN_POWER
Wire Wire Line
	7835 5100 7835 5180
Wire Wire Line
...
U 1 1 5EF1FE62
P 6155 3310
F 0 "#PWR024" H 6155 3160 50  0001 C CNN
F 1 "+5V" H 6170 3483 50  0000 C CNN
F 2 "" H 6155 3310 50  0001 C CNN
F 3 "" H 6155 3310 50  0001 C CNN
	1    6155 3310
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5F2B9B1E
P 9345 4310
F 0 "R8" H 9410 4280 50  0000 L CNN
F 1 "1M" H 9415 4345 50  0000 L CNN
F 2 "" H 9345 4310 50  0001 C CNN
F 3 "~" H 9345 4310 50  0001 C CNN
	1    9345 4310
	-1   0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 5F2D1230
P 9345 5195
F 0 "#PWR028" H 9345 4945 50  0001 C CNN
F 1 "GNDA" H 9350 5022 50  0000 C CNN
F 2 "" H 9345 5195 50  0001 C CNN
F 3 "" H 9345 5195 50  0001 C CNN
	1    9345 5195
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5F2DDF4B
P 6305 3895
F 0 "#PWR025" H 6305 3645 50  0001 C CNN
F 1 "GNDA" H 6310 3722 50  0000 C CNN
F 2 "" H 6305 3895 50  0001 C CNN
F 3 "" H 6305 3895 50  0001 C CNN
	1    6305 3895
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F2E1016
P 6615 3895
F 0 "#PWR026" H 6615 3645 50  0001 C CNN
F 1 "GNDA" H 6620 3722 50  0000 C CNN
F 2 "" H 6615 3895 50  0001 C CNN
F 3 "" H 6615 3895 50  0001 C CNN
	1    6615 3895
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F2E1CBF
P 7835 5180
F 0 "#PWR027" H 7835 4930 50  0001 C CNN
F 1 "GNDA" H 7840 5007 50  0000 C CNN
F 2 "" H 7835 5180 50  0001 C CNN
F 3 "" H 7835 5180 50  0001 C CNN
	1    7835 5180
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	8435 4300 9000 4300
Text Label 8435 4300 0    50   ~ 0
Supply_Detect
$Comp
L MCU_Microchip_ATtiny:ATtiny814-SS U3
U 1 1 5EE6BDE9
P 7835 4400
F 0 "U3" H 7270 5115 50  0000 C CNN
F 1 "ATtiny814-SS" H 7485 5045 50  0000 C CNN
F 2 "Package_SO:SOIC-14_3.9x8.7mm_P1.27mm" H 7835 4400 50  0001 C CIN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/40001912A.pdf" H 7835 4400 50  0001 C CNN
	1    7835 4400
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5EE88359
P 770 5265
F 0 "#PWR029" H 770 5015 50  0001 C CNN
F 1 "GNDA" H 775 5092 50  0000 C CNN
F 2 "" H 770 5265 50  0001 C CNN
F 3 "" H 770 5265 50  0001 C CNN
	1    770  5265
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5EEB7C53
P 5295 4900
F 0 "TP4" V 5285 5355 50  0000 C CNN
F 1 "GND" V 5295 5150 50  0000 C CNN
F 2 "" H 5495 4900 50  0001 C CNN
F 3 "~" H 5495 4900 50  0001 C CNN
	1    5295 4900
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5EEE8CA3
P 5295 5000
F 0 "#PWR031" H 5295 4750 50  0001 C CNN
F 1 "GNDA" H 5300 4827 50  0000 C CNN
F 2 "" H 5295 5000 50  0001 C CNN
F 3 "" H 5295 5000 50  0001 C CNN
	1    5295 5000
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5EEBD8E0
P 5295 4760
F 0 "TP3" V 5290 5215 50  0000 C CNN
F 1 "UDPI" V 5290 5025 50  0000 C CNN
F 2 "" H 5495 4760 50  0001 C CNN
F 3 "~" H 5495 4760 50  0001 C CNN
	1    5295 4760
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5EEBD3EB
P 5300 4640
F 0 "TP5" V 5295 5100 50  0000 C CNN
F 1 "5V" V 5295 4865 50  0000 C CNN
F 2 "" H 5500 4640 50  0001 C CNN
F 3 "~" H 5500 4640 50  0001 C CNN
	1    5300 4640
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5EF46672
P 5300 4525
F 0 "#PWR032" H 5300 4375 50  0001 C CNN
F 1 "+5V" H 5315 4698 50  0000 C CNN
...
Wire Wire Line
	5295 4760 5540 4760
Text Label 5540 4760 2    50   ~ 0
PRGM
Text Notes 4915 4260 0    50   ~ 0
JTAG Interface \n
$Comp
L power:+10V #PWR023
U 1 1 5F378EC4
